...
st.markdown(
    '<div class="main-title">SkyCity Auckland Order Channel Intelligence</div>',
    unsafe_allow_html=True
)
st.caption("Unified Mentor SkyCity Auckland Hospitality Market Intelligence Dashboard")
...
Strengthen direct channels (In-Store & Self-Delivery) to improve margin stability and reduce commission exposure.
"""
